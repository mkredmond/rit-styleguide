import{r as S,a as g,b as m,c as y}from"./Row-BKnN5jBN.js";const M={title:"Components/Lists",argTypes:{outer_container_classes:{control:"object",description:"Array of row classes to generate",table:{disable:!0}},listClass:{control:"multi-select",options:["list-style-none","columns-2","columns-3","columns-4","columns-4","links-list-with-arrows","links-list","arrows-left"],description:"Class to apply to the <ul> element",defaultValue:"list-style-none"},content:{control:"text",table:{disable:!0}}},parameters:{controls:{expanded:!0}}},f=({listClass:e,content:n,...v})=>{const t=`<ul class="${Array.isArray(e)?Array.from(e).join(" "):e}">
    ${n}
  </ul>`,l={...m,field_content:t};return S.map(x=>g({...y,field_background_color:{value:x}},l)).join(`
`)},s=f.bind({});s.args={listClass:"",content:`
  ...
  `};const a=f.bind({});a.args={listClass:"columns-3 list-style-none",content:`
          <li>
...
`};const i=({listClass:e="mb-5 links-list list-style-none columns-3",content:n,...v})=>{const t=`<ul class="${Array.isArray(e)?Array.from(e).join(" "):e}">
  ...
  <li class="views-row pb-3">
    ...
    </ul>`,l={...m,field_content:t};return g({...y,field_background_color:{value:"has_white_background"}},l)};var r,o,c;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`({
  listClass,
  content,
  ...args
}) => {
...
}`,...(c=(o=s.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var p,d,u;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`({
  listClass,
  content,
  ...args
}) => {
...
}`,...(u=(d=a.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};var w,h,b;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`({
  ...
  return renderRow({
    ...rowParagraphObject,
    field_background_color: {
      value: "has_white_background"
    }
  }, html);
}`,...(b=(h=i.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};const D=["Default","ListsWithCustomIcons","ProgramsOfStudyListing"];export{s as Default,a as ListsWithCustomIcons,i as ProgramsOfStudyListing,D as __namedExportsOrder,M as default};
